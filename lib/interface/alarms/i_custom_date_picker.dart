...
///
Future<DateTime?> showSDatePicker(
...
///
/// It is used internally by [showSDatePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showSDatePicker] for a state restoration app example.
///
/// See also:
///
///  * [showSDatePicker], which is a way to display the date picker.
...
class _CustomDatePickerDialogState extends State<CustomDatePickerDialog>
  ...
  late final _RestorableSDatePickerEntryMode _entryMode =
      _RestorableSDatePickerEntryMode(widget.initialEntryMode);
  ...
  Widget build(BuildContext context) {
    ...
    final Widget header = _SDatePickerHeader(
...
class _RestorableSDatePickerEntryMode
    extends RestorableValue<DatePickerEntryMode> {
  _RestorableSDatePickerEntryMode(
...
/// non-null.
class _SDatePickerHeader extends StatelessWidget {
  /// Creates a header for use in a date picker dialog.
  const _SDatePickerHeader({
    Key? key,
